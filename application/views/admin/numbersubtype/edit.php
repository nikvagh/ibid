                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <form name="form1" id="form1" action="<?php echo base_url() . ADMINPATH; ?>numbersubtype/edit" method="post" enctype="multipart/form-data" class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="number_type_id" id="number_type_id">
                                            ...
                                            <?php foreach($numbertypes as $val){ ?>
                                                <option value="<?php echo $val['id']; ?>" <?php if ($form_data['number_type_id'] == $val['id']) { echo "selected"; } ?>><?php echo $val['name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Sub Name</label>
                                        <input type="text" class="form-control" name="sub_name" id="sub_name" placeholder="Enter Sub Name" value="<?php echo $form_data['sub_name']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select class="form-control" name="status" id="status">
                                            <option value="Enable" <?php if ($form_data['status'] == "Disable") { echo "selected"; } ?>>Enable</option>
