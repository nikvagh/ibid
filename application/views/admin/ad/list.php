                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo base_url().ADMINPATH; ?>ad/exportXLS" class="btn bg-black btn-flat">Export Xls</a>
                                            ...
                                            <div class="col-md-3 text-right">
                                                <div class="form-group">
                                                    <label for="">&nbsp;</label><br/>
                                                    <a href="<?php echo base_url().ADMINPATH;?>ad/add" class="btn bg-black btn-flat">Add New <?php echo $title; ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                                ...
                                                <?php foreach ($manage_data as $val): ?>
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <a href="<?php echo base_url().ADMINPATH; ?>ad/edit/<?php echo $val['id']; ?>" class="btn btn-warning btn-flat">Edit</a>
