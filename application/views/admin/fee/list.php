                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <!-- <div class="box-header text-right">
                                    <a href="<?php echo base_url().ADMINPATH;?>fee/add">
                                        <button class="btn bg-black btn-flat"> Add New <?php echo $title; ?></button>
                                    </a>
                                </div> -->
                                <div class="box-body">
                                    
                                    <form action="<?=base_url().ADMINPATH;?>fee/filter" method="post">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="">Date From Start</label>
                                                    <input type="text" name="filter_date_start" id="filter_date_start" class="form-control" value="<?php if(isset($_SESSION['fee']['filter_date_start'])){ echo $_SESSION['fee']['filter_date_start']; } ?>" autocomplete="off"/>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="">Date From End</label>
                                                    <input type="text" name="filter_date_end" id="filter_date_end" class="form-control" value="<?php if(isset($_SESSION['fee']['filter_date_end'])){ echo $_SESSION['fee']['filter_date_end']; } ?>" autocomplete="off"/>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo base_url().ADMINPATH; ?>fee/exportXLS" class="btn bg-black btn-flat">Export Xls</a>
                                                </div>
                                            </div>
                                            <div class="col-md-3 text-right">
                                                <div class="form-group">
                                                    <label for="">&nbsp;</label><br/>
                                                    <a href="<?php echo base_url().ADMINPATH;?>fee/add" class="btn bg-black btn-flat">Add New <?php echo $title; ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>

                                    <form name="datatableForm" id="datatableForm" action="<?=base_url().ADMINPATH;?>fee" method="post" enctype="multipart/form-data">
                                            ...
                                            <tbody>
                                                <?php foreach ($manage_data as $val): ?>    
                                                    <tr>
                                                        ...
                                                        <td><?php echo $val['start_amount']; ?></td>
                                                        <td><?php echo $val['to_amount']; ?></td>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <a href="<?php echo base_url().ADMINPATH; ?>fee/edit/<?php echo $val['id']; ?>" class="btn btn-warning btn-flat">Edit</a>
