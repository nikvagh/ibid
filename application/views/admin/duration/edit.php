                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <form name="form1" id="form1" action="<?php echo base_url() . ADMINPATH; ?>duration/edit" method="post" enctype="multipart/form-data" class="">
                                <input type="hidden" name="id" value="<?php echo $form_data['id']; ?>">

                                <div class="box-body">
                                    <div class="form-group">
                                        <label>Number Of Days</label>
                                        <input type="text" class="form-control" name="no_of_days" id="no_of_days" placeholder="Enter Number Of Days" value="<?php echo $form_data['no_of_days']; ?>">
                                    </div>
                                    <div class="form-group">
