                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <form name="form1" id="form1" action="<?php echo base_url();?>product/edit" method="post" enctype="multipart/form-data" class="">
                                        ...
                                        <label for="company_id">Company</label>
                                            <select class="form-control" name="company_id" id="company_id">
                                                ...
                                                <?php foreach($companies as $val){ ?>
                                                    <option value="<?php echo $val['id']; ?>" <?php if($form_data['company_id'] == $val['id']){ echo "selected"; } ?>><?php echo $val['company_name']; ?></option>
                                                <?php } ?>-
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="product_name">Product name</label>
                                            <input type="text" class="form-control" name="product_name" id="product_name" placeholder="Enter Product Name" value="<?php echo $form_data['product_name']; ?>">
                                        </div>
                                        <div class="form-group">
